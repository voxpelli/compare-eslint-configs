...
- **ESLint 10 peer dependency** (2026-03-29) — `peerDependencies.eslint: ^9.13.0` blocks ESLint 10 resolution in downstream projects. Downstream tools declaring `eslint: ^9.13.0 || ^10.0.0` must use `--legacy-peer-deps` for dev workflows until widened.
