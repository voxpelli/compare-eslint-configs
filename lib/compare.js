 ...
 * @param {{ targetFile: string, verbose?: boolean | undefined }} options
 * @returns {{ [ruleName: string]: RuleSummary}}
 */
export function summarizeConfigs (configs, { targetFile, verbose } = /** @type {*} */ ({})) {
 ...
 */
export function compareConfigs (configs, { targetFile, verbose } = /** @type {*} */ ({})) {
