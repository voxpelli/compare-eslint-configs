...
/**
 * @typedef PrintConfigSummaryOptions
 ...
 * @param {PrintConfigSummaryOptions} options
 * @returns {void}
 */
export function printConfigSummary (configName, summary, options) {
  const format = new MarkdownOrChalk(options.outputMarkdown);
 ...
 */
function formatConfigSummaryList (sortedRules, { outputMarkdown, skipLinks, verboseConfigs }) {
 ...
 */
function formatConfigSummaryTable (sortedRules, { outputMarkdown, skipLinks, verboseConfigs }) {
