...
export const summary = {
  ...
  async run (argv, meta, { parentName }) {
    ...
    const jsonAccumulator = jsonOutput ? {} : undefined;
    ...
    for (const [configName, config] of Object.entries(configs)) {
      ...
      if (jsonAccumulator) {
        ...
        const serializable = {};
        for (const [ruleName, ruleSummary] of Object.entries(summarizedRules)) {
          serializable[ruleName] = {
            ...ruleSummary,
            docUrls: ruleSummary.docUrls ? [...ruleSummary.docUrls] : undefined,
          };
        }
        jsonAccumulator[configName] = serializable;
        continue;
      }
    ...
    if (jsonAccumulator) {
      ...
      console.log(JSON.stringify(jsonAccumulator, undefined, 2));
    }
  },
};
