...
export function printAuditResult (result, { markdown, showUnconfigured, skipLinks }) {
  ...
  const statsLines = [
    ...
    `  Builtin coverage: ${result.stats.totalBuiltinsConfigured} / ${result.stats.totalBuiltinsActive} active builtins (${Math.round(result.stats.totalBuiltinsConfigured / result.stats.totalBuiltinsActive * 100)}%)`,
